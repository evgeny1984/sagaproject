...
using Sp.HotelBooking.Api.TaskHandlers;
using System;

namespace Sp.HotelBooking.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCamundaWorker(workerId: "hotel-worker", numberOfWorkers: 3)
                .AddHandler<BookHotelHandler>()
                .AddHandler<CancelHotelHandler>()
